...
class common:
    ...
    @staticmethod
    def get_counts(word_histogram: str, word_vocab_size: int, path_histogram: str, path_vocab_size: int,
                   target_histogram: str, target_vocab_size: int):
        word_histogram_data = common.load_vocab_from_histogram(word_histogram, start_from=1,
                                                               max_size=word_vocab_size, return_counts=True)
        _, _, _, word_to_count = word_histogram_data
        _, _, _, path_to_count = common.load_vocab_from_histogram(path_histogram, start_from=1,
                                                                  max_size=path_vocab_size, return_counts=True)
        _, _, _, target_to_count = common.load_vocab_from_histogram(target_histogram, start_from=1, return_counts=True,
